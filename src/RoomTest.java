...
public class RoomTest {
	...
	public void testSetMonster() {
		...
		Monster wolf = new Monster("wolf", 2, 1, 3, "a ferocious, snarling wolf");
	...
	public void testSetWeapon() {
		...
		Weapon axe = new Weapon("Battleaxe", 6, 8, "a very heavy steel battleaxe");
		hall.setWeapon(axe);
	...
	public void testSetMedicine() {
		assertNull(hall.getMedicine());
		Medicine bandage = new Medicine("bandage", 10,
				"a rag soaked in alcohol");
		hall.setMedicine(bandage);
		assertSame(bandage, hall.getMedicine());
	}
